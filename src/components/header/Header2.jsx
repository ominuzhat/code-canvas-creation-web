...
import logo from "../../../public/code canvas creations/code canvas creation.png";
...
const Header2 = () => {
  ...
  const isEmptyUser = !user || !user.firstName;
            ...
            <div className="sidebar-and-btn">
              ...
              {!isEmptyUser ? (
                <div className="dropdown">
                  <button
                    className="primary-btn4 d-xl-flex d-none dropdown-toggle"
                    type="button"
