...
const Footer3 = () => {
  const [officeInfo, refetch, isLoading] = useOfficeInfo();
                ...
                <div className="footer-widget">
                  <div className="footer-logo">
                    <Link href="/">
                      ...
                      />
                      {/* <Image
                        src="/public/code canvas creations/icon.png"
                        alt="code canvas solution"
                        width={200}
                        height={150}
                      /> */}
                    </Link>
                  ...
                  <div className="content">
                    <p>
                      Welcome to Code Canvas Creation, where innovation meets
          ...
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="tel:+880 - 1601 477 401">+{phone}</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
            ...
            <div className="hotline-area">
              ...
              <div className="content">
                <span>Say Hello</span>
                <h6>
                  <a href="mailto:info@example.com">{officialEmail}</a>
                </h6>
              </div>
            </div>
          </div>
