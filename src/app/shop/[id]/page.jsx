...
const ProductDetailsPage = () => {
  ...
  useEffect(() => {
    const fetchproductDetails = async () => {
      try {
        const response = await instance.get(`/product/${dynamicPart}`);
  ...
  const { title, description, support_for, images, subtitle, price } =
    product?.data || {};
  ...
  const handleAddToCart = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        ...
        router.push("/cart");
        enqueueSnackbar(`Cart added SuccessFully `, {
          variant: "success",
        });
      }
    } catch (error) {
          ...
          <div className="row gy-5">
            <div className="col-lg-6">
              <div className="product-details-img">
                ...
                >
                  {images?.map((image, index) => (
                    <li className="nav-item" role="presentation" key={image.id}>
                      <button
                        className={`nav-link ${
              ...
              <div className="product-details-content">
                ...
                {/* <div className="quantity-area">
                  ...
                  <div className="quantity-counter">
                    ...
                    >
                      <i className="bx bx-minus" onClick={decrement} />
                    </a>
                    <input
                      name="quantity"
                      type="text"
                    ...
                    <a className="quantity__plus" style={{ cursor: "pointer" }}>
                      <i className="bx bx-plus" onClick={increment} />
                    </a>
                  </div>
                </div> */}
                  ...
                  cartList?.data[0]?.products?.map((pd) => (
                    <div className="product-details-btn" key={pd?.id}>
                      {pd?.id === dynamicPart ? (
                        ...
                        <Link href="/cart" legacyBehavior>
                          <a className="primary-btn1" data-text="Go to cart">
                            <span>Already added to cart</span>
                          </a>
                        </Link>
                      )}
                      <Link href="/checkout" legacyBehavior>
                        <a className="primary-btn2" data-text="Buy Now">
                          <span>Buy Now</span>
                        </a>
                      </Link>
                    </div>
